...
func (c *multiverseClient) PublishEvent(ctx context.Context, in *Event, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/service.Multiverse/PublishEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *multiverseClient) Events(ctx context.Context, in *Filter, opts ...grpc.CallOption) (Multiverse_EventsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Multiverse_ServiceDesc.Streams[0], "/service.Multiverse/Events", opts...)
	if err != nil {
		return nil, err
	}
...
func _Multiverse_PublishEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.Multiverse/PublishEvent",
	}
...
var Multiverse_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "service.Multiverse",
	...
	Metadata: "pkg/multiverse/service/service.proto",
}
